...
函数的目的就是找到一个拟合线：z= w0*x0 + w1*x1 + w2*x2 +...+wn*xn (其中取 x0=1) 使每个样本可以通过z值尽可能的区别开来且按照标签聚类。
这里的我们最好使用阶跃函数来对二分类样本分类，但是阶跃函数的跳变不易实现，取而代之使用sigmoid函数：
>>>>>>> 3ad6ae46ade43a726049ad2020957d340f3cb151
